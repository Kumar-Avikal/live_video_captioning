    ...
    def main(self, filename, caption):
        ...
        while cap1.isOpened():
            ...
            if ret:
                ...
                cv2.putText(imS, caption, (100, 270), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0),
                            2, cv2.LINE_4)
...
if __name__ == "__main__":
    record_video(5, 'D:\\live video captionong\\Video-Captioning\\data\\testing_data\\video\\test.avi')
